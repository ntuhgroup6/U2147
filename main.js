...
var MeetingRoomsService = /** @class */ (function () {
    function MeetingRoomsService(http) {
        this.http = http;
        //readonly rootUrl='https://localhost:44332/api/meetingrooms'
        this.rootUrl = '';
        this.rootUrl = src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_2__["environment"].production ? 'http://localhost/mywebapi/api/MeetingRooms'
            : 'http://localhost:44332/api/MeetingRooms:';
    }
    ...
    MeetingRoomsService.prototype.getByID = function (id) {
        ...
        this.http.get(this.rootUrl + ("/" + id))
            .toPromise()
            .then(function (resp) { return _this.formData = resp; });
    };
...
/* harmony import */ var _booking_booking_detail_booking_detail_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./booking/booking-detail/booking-detail.component */ "./src/app/booking/booking-detail/booking-detail.component.ts");
/* harmony import */ var _booking_add2_calendar_add2_calendar_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./booking/add2-calendar/add2-calendar.component */ "./src/app/booking/add2-calendar/add2-calendar.component.ts");
/* harmony import */ var _booking_rental_device_rental_device_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./booking/rental-device/rental-device.component */ "./src/app/booking/rental-device/rental-device.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    ...
    //child route
    { path: 'booking/:id', component: _booking_booking_detail_booking_detail_component__WEBPACK_IMPORTED_MODULE_5__["BookingDetailComponent"],
        children: [
            { path: 'calendar', component: _booking_add2_calendar_add2_calendar_component__WEBPACK_IMPORTED_MODULE_6__["Add2CalendarComponent"] },
            { path: 'device', component: _booking_rental_device_rental_device_component__WEBPACK_IMPORTED_MODULE_7__["RentalDeviceComponent"] }
        ]
    },
...
module.exports = "<div style=\"margin:15px\">\n  <h1 style=\"text-align:center;\">\n    Welcome to {{ title }}!\n  </h1>\u000b<nav><ul class=\"nav nav-tabs\">\n  <li class=\"nav-item\">\n  <a class=\"nav-link\" routerLink='/booking'\n    routerLinkActive=\"active\">會議室預約</a>\n  </li>\n  <li class=\"nav-item\">\n  <a class=\"nav-link\" routerLink='/meetingroomapp' \n      routerLinkActive=\"active\">會議室基本資料</a>\n  </li>\n  </ul></nav>\n  <div class=\"card\">\n    <router-outlet></router-outlet>\n  </div>\n  </div>\n  "
...
/* harmony import */ var _booking_booking_detail_booking_detail_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./booking/booking-detail/booking-detail.component */ "./src/app/booking/booking-detail/booking-detail.component.ts");
/* harmony import */ var _booking_add2_calendar_add2_calendar_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./booking/add2-calendar/add2-calendar.component */ "./src/app/booking/add2-calendar/add2-calendar.component.ts");
/* harmony import */ var _booking_rental_device_rental_device_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./booking/rental-device/rental-device.component */ "./src/app/booking/rental-device/rental-device.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _meeting_rooms_app_meeting_room_detail_meeting_room_detail_component__WEBPACK_IMPORTED_MODULE_10__["MeetingRoomDetailComponent"], _page_not_found_page_not_found_component__WEBPACK_IMPORTED_MODULE_12__["PageNotFoundComponent"], _booking_booking_detail_booking_detail_component__WEBPACK_IMPORTED_MODULE_13__["BookingDetailComponent"], _booking_add2_calendar_add2_calendar_component__WEBPACK_IMPORTED_MODULE_14__["Add2CalendarComponent"], _booking_rental_device_rental_device_component__WEBPACK_IMPORTED_MODULE_15__["RentalDeviceComponent"]
            ],
            imports: [
...
/***/ "./src/app/booking/add2-calendar/add2-calendar.component.ts":
/*!******************************************************************!*\
  !*** ./src/app/booking/add2-calendar/add2-calendar.component.ts ***!
  \******************************************************************/
/*! exports provided: Add2CalendarComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Add2CalendarComponent", function() { return Add2CalendarComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var Add2CalendarComponent = /** @class */ (function () {
    function Add2CalendarComponent() {
    }
    Add2CalendarComponent.prototype.ngOnInit = function () {
    };
    Add2CalendarComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-add2-calendar',
            template: "\n    <p>\n      add2-calendar works!\n    </p>\n  ",
            styles: []
        }),
        __metadata("design:paramtypes", [])
    ], Add2CalendarComponent);
    return Add2CalendarComponent;
}());
...
/***/ "./src/app/booking/booking-detail/booking-detail.component.html":
/*!**********************************************************************!*\
  !*** ./src/app/booking/booking-detail/booking-detail.component.html ***!
  \**********************************************************************/
/*! no static exports found */
...
module.exports = "<h4><span *ngIf=\"this.service.formData; else IsNull\">\n    你成功預訂了#{{this.id}} -- {{this.service.formData.Name}}\n  </span>\u000b\n  <ng-template #IsNull>\n    {{this.id}} 不存在\n  </ng-template>\n</h4>\n\n<div class=\"btn-toolbar\" role=\"toolbar\">\n  <div class=\"btn-group \" role=\"group\">\n    <a [routerLink]=\"['calendar']\" routerLinkActive=\"active\" class='btn btn-info btn-lg' title=\"加入月曆\">\n      <i class=\"far fa-calendar-alt\"></i>\n    </a>\n    <a [routerLink]=\"['device']\" routerLinkActive=\"router-link-active\" class='btn btn-info btn-lg' title=\"租借設備\">\n      <i class=\"fas fa-laptop-medical\"></i>\n    </a>\n  </div>\n</div>\n<div>\n  <router-outlet></router-outlet>\n</div>\n\n\n<a [routerLink]=\"['/booking']\" routerLinkActive=\"router-link-active\" \n  class=\"btn btn-warning\">\n  <i class=\"fas fa-arrow-left\"></i> 回到前一頁\n</a>"

/***/ }),

/***/ "./src/app/booking/booking-detail/booking-detail.component.ts":
/*!********************************************************************!*\
  !*** ./src/app/booking/booking-detail/booking-detail.component.ts ***!
  \********************************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var src_app_Shared_meeting_rooms_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! src/app/Shared/meeting-rooms.service */ "./src/app/Shared/meeting-rooms.service.ts");
...
var BookingDetailComponent = /** @class */ (function () {
    ...
    BookingDetailComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./booking-detail.component.html */ "./src/app/booking/booking-detail/booking-detail.component.html"),
            styles: []
        }),
        __metadata("design:paramtypes", [src_app_Shared_meeting_rooms_service__WEBPACK_IMPORTED_MODULE_1__["MeetingRoomsService"],
...
/***/ "./src/app/booking/rental-device/rental-device.component.ts":
/*!******************************************************************!*\
  !*** ./src/app/booking/rental-device/rental-device.component.ts ***!
  \******************************************************************/
/*! exports provided: RentalDeviceComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RentalDeviceComponent", function() { return RentalDeviceComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var RentalDeviceComponent = /** @class */ (function () {
    function RentalDeviceComponent() {
    }
    RentalDeviceComponent.prototype.ngOnInit = function () {
    };
    RentalDeviceComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
...
module.exports = __webpack_require__(/*! C:\U2147\Mod10\src\main.ts */"./src/main.ts");
